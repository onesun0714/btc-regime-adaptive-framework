...
[![White Paper](https://img.shields.io/badge/Download-White_Paper_(PDF)-1B2B5E?style=flat-square)](BTC_Cycle_Strategy_V17_WhitePaper.pdf)
...
| **Max Drawdown** | **-58.5%** | -81.5% | -59.0% |
| **Calmar Ratio** | **0.50** | 0.27 | 0.31 |
| **Profit Factor** | **3.97** | N/A | N/A |

Initial capital of $100,000 grows to **$861,916** (vs $535,390 for buy-and-hold, 1.61x multiple).
...
- **5pp drawdown improvement** (compounds with leverage — 7.5pp at 1.5x)
...
├── README.md                                  # This file
├── BTC_Cycle_Strategy_V17_WhitePaper.pdf      # Full white paper (English)
├── docs/
...
└── results/
    ├── strategy_v17_equity.csv                # Daily equity curve
...
| On-chain (MVRV, NUPL, SOPR, MVRV Z) | BGeometrics, CoinMetrics |
...
```
Lee, O. (2026). BTC Cycle Strategy V17: A systematic framework applying
