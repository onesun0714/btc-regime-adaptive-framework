...
Built by a commodity trader with over 12 years of experience (Samsung C&T crude/naphtha/petrochemicals → TRIPTIK TRADING SA (Geneva)) pursuing an MBA at USC Marshall. The framework applies commodity trading principles from both physical and derivatives markets — regime-dependent positioning, spread-based mean reversion, inventory cycle analysis — to crypto markets.
